...
export function AccountSubHeaderDrawer({ isOpen, closeDrawer }: Props) {
  ...
  return (
    ...
    >
      <Box px={40} py={40}>
        <Title>{t("celo.account.subHeader.title")}</Title>
        <Box py={3}>
          <Description>{t("celo.account.subHeader.description")}</Description>
        </Box>
        <Box py={2}>
          <Description>{t("celo.account.subHeader.description2")}</Description>
        </Box>
        <Divider mt={2} />
        <Box mt={3}>
